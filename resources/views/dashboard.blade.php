...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    <head>
        ...
        <title>SOY YPIK PAM JAYA - Ringkasan & Monitoring</title>
    ...
    <body class="h-full text-slate-100 antialiased bg-[#0f111a]">
        ...
        <header class="h-16 bg-[#07080f] border-b border-[#1f243d] flex items-center justify-between px-6 w-full fixed top-0 left-0 z-50">
            ...
            <!-- Right side: Mode Gelap, Language, User profile -->
        ...
        <div class="flex h-full min-h-screen pt-16">
            ...
            <!-- SIDEBAR (Matching Mockup Menu Items and Logos) -->
            <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-[#07080f] border-r border-[#1f243d] transition-transform duration-300 -translate-x-full lg:translate-x-0 pt-16">
                ...
                <nav class="flex-1 space-y-1 px-3 py-6 overflow-y-auto">
                    <a href="{{ url('/dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-[#2f54eb] text-white transition-all duration-150 shadow-md shadow-blue-500/10">
                        <i data-lucide="layout-dashboard" class="w-4 h-4"></i>
                        <span class="font-bold text-xs uppercase tracking-wider">Dashboard</span>
                    </a>
                    
                    <a href="{{ url('/anggota') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-[#8f9bb3] hover:text-white hover:bg-[#16192b] transition-all duration-150">
    ...
    <div class="footer-mini hidden text-center">
            ...
            <div id="main-container" class="flex-grow flex flex-col min-w-0 lg:pl-64">
                ...
                <main class="flex-1 p-6 lg:p-8 space-y-8 w-full">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        ...
                        <!-- Card 1: Total Simpanan Anggota (Styled exactly like mockup left invoice card) -->
                        <div class="bg-[#16192b] border border-[#1f243d] rounded-xl p-6 flex flex-col justify-between min-h-[220px] relative overflow-hidden group hover:border-[#8f9bb3]/30 transition-all duration-300">
                            ...
                            <div>
                                ...
                                <!-- Title Label (Uppercase, small, green dot prefix matching mockup) -->
                            ...
                            <!-- Bottom Link Action and breakdowns -->
                            <div class="mt-4 pt-4 border-t border-[#1f243d] space-y-2">
                                ...
                                <a href="#" onclick="showNotImplementedAlert('Simpanan')" class="text-xs font-bold text-[#2f54eb] hover:underline flex items-center gap-1 pt-1">
                        ...
                        <!-- Card 2: Welcome Banner Card (Styled exactly like mockup right welcome banner) -->
                        <div class="xl:col-span-2 bg-gradient-to-r from-[#2f54eb]/95 to-[#1d39c4]/90 border border-blue-500/20 rounded-xl p-6 flex flex-col justify-between min-h-[220px] relative overflow-hidden text-white shadow-xl shadow-blue-500/5">
                            ...
                            <!-- Horizontal Grid Sub-cards (MODUL AKTIF, REFRESH DATA, STATUS) -->
                    ...
                    <!-- Superadmin Tools Section (Section Header Divider matching the mockup) -->
                    <div class="space-y-6 pt-2">
                        ...
                        <!-- Card 3 & 4 (Pinjaman Berjalan & Saldo Kas Koperasi) -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            
                            <!-- Card 3: Pinjaman Berjalan (Consistent styling with Left Card) -->
                            <div class="bg-[#16192b] border border-[#1f243d] rounded-xl p-6 flex flex-col justify-between min-h-[170px] relative overflow-hidden group hover:border-[#8f9bb3]/30 transition-all duration-300">
                                ...
                                <div class="mt-4 pt-3 border-t border-[#1f243d] flex items-center justify-between text-[10px] text-[#8f9bb3]">
                                    ...
                                    <a href="#" onclick="showNotImplementedAlert('Pinjaman')" class="text-[#2f54eb] hover:underline font-bold">Rincian Pinjaman</a>
                                </div>
                            </div>

                            <!-- Card 4: Saldo Kas Koperasi (Consistent styling with Left Card) -->
                            <div class="bg-[#16192b] border border-[#1f243d] rounded-xl p-6 flex flex-col justify-between min-h-[170px] relative overflow-hidden group hover:border-[#8f9bb3]/30 transition-all duration-300">
                                <div>
                                    <div class="flex items-center gap-1.5">
                    ...
                    <!-- Double Column Grid (Equal height lists) -->
                        ...
                        <div class="bg-[#16192b] border border-[#1f243d] rounded-xl p-5 flex flex-col justify-between h-full">
                            <div>
                                ...
                                <div class="divide-y divide-[#1f243d]">
                                    ...
                                    <div class="py-4 flex items-center justify-between hover:bg-[#07080f]/30 px-2 rounded-lg transition-colors gap-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-9 h-9 rounded-xl bg-rose-500/10 text-rose-400 flex items-center justify-center font-bold text-xs shrink-0">
                                                AW
                                            </div>
                                            <div>
        ...
        <script>
            ...
            // Mock Data for period switching
            const chartData = {
                mingguan: {
                            ...
                            ticks: {
                                ...
                                callback: function(value) {
                                    if (value >= 1e9) {
                                        ...
                                        return 'Rp ' + (value / 1e6).toFixed(0) + ' Juta';
                                    } else if (value >= 1e3) {
                                        return 'Rp ' + (value / 1e3).toFixed(0) + ' Ribu';
                                    }
                                    return 'Rp ' + value;
                                }
                            }
            ...
            function submitTransaction(event) {
                ...
                // Add to table dynamically for demo feedback
