...
<div
    id="loanModal"
    class="loan-modal"
    onclick="closeLoanModalOutside(event)"
>

    <div
        class="loan-modal-box"
    ...
    >
        ...
        <form
            method="POST"
            action="{{ route('customer.pinjaman.store') }}"
        >
            ...
            <div class="loan-form-group">
                ...
                <textarea
                    id="keterangan"
                    name="keterangan"
                    placeholder="Jelaskan keperluan pengajuan pinjaman..."
